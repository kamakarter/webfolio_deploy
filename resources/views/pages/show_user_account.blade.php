...
@section('content')
    ...
    <section class="user-header" id="user-header">
        <div class="container">
            <img src="../../assets/media/backgrounds/base_bg_for_user.svg" alt="user-background" class="user-header-bg">
        </div>
    </section>
        ...
        <div class="container user_base_container">
            <div class="user_base_data">
                <div class="user_avatar_frame">
                    <img src="../assets/icons/default_avatar.svg" alt="user-avatar" class="user-avatar">
            ...
            <div class="user_base_actions">
                <a href="#" class="btn btn-s btn-1" id="ShareMyProfile">
                ...
                <div class="user_resume_info">
                    ...
                    <div class="placeholder_for_user_data_about">
                        <p class="user_data_about">
                            Пользователь не заполнил описание профиля
                        </p>
                    </div>
                    ...
                    <!-- skills -->
                    <p class="skills_title">Навыки и используемые технологии</p>
                ...
                <div class="user_resume_links">
                    ...
                    <div class="user-link_box">
                        ...
                        <a href="#" class="user-link" target="_blank">
                            ...
                            <svg class="user-link_arrow" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 20 20" fill="none">
                                <path
                                    d="M14.2049 12.6736L14.2049 7.23436M14.2049 7.23436H8.76564M14.2049 7.23436L5.71964 15.7196"
                                    stroke="#46A7FE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                    </div>
                    ...
                    <div class="user-link_box">
                        ...
                        <a href="mailto:email@example.com" class="user-link" target="_blank">
                            <div class="user-link_placeholder">
                                email@example.com
                            </div>
                    ...
                    <div class="user-link_box">
                        ...
                        <a href="tel:+79872766705" class="user-link" target="_blank">
                            <div class="user-link_placeholder">
                                +7 (987) 276-67-05
                            </div>
                    ...
                    <div class="user-link_box">
                        ...
                        <a href="https://t.me/username" class="user-link" target="_blank">
                            <div class="user-link_placeholder">
                                t.me/username
                            </div>
                            <svg class="user-link_arrow" xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <div class="user-link_box">
                        ...
                        <a href="https://wa.me/username" class="user-link" target="_blank">
                            <div class="user-link_placeholder">
                                wa.me/username
                            </div>
                            <svg class="user-link_arrow" xmlns="http://www.w3.org/2000/svg" width="20"
    ...
    <script>
        const FullUserDescruption = document.querySelector('.placeholder_for_user_data_about');
        ...
        BtnOpenFullDescription.addEventListener('click', function() {
            FullUserDescruption.classList.toggle('full-size');
                ...
                <div class="user-exp_card">
                    <div class="user-exp_information">
                        <p class="user-exp_job">
                            Должность: Пример должности
                        </p>
                        <p class="user-exp_company">
                            Организация: Пример организации
                        </p>
                        <div class="user-exp_date_box">
                            <p class="user-exp_start">January 1, 2020</p>
                            —
                            <p class="user-exp_end">December 31, 2023</p>
                        </div>
                        <ul class="exp-task">
                            <li>Пример задачи 1</li>
                            <li>Пример задачи 2</li>
                            <li>Пример задачи 3</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="user-projects_box">
                <div class="user-project-card">
                    <div class="user-project-cover">
                        <img class="cover-image" src="path/to/cover.jpg" alt="cover">
                    </div>
                    ...
                    <div class="user-project_links">
                        ...
                        <a href="#" class="user-project_link btn-2 btn-xs">
                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8 0.5C3.58214 0.5 0 4.17143 0 8.70357C0 12.3286 2.29286 15.4 5.47143 16.4857C5.87143 16.5607 6.01786 16.3071 6.01786 16.0893C6.01786 15.8929 6.01071 15.3786 6.00714 14.6929C3.78214 15.1893 3.31071 13.5929 3.31071 13.5929C2.94643 12.6464 2.42143 12.3929 2.42143 12.3929C1.69643 11.8821 2.475 11.8929 2.475 11.8929C3.27857 11.95 3.7 12.7393 3.7 12.7393C4.41429 13.9929 5.57143 13.6321 6.02857 13.4214C6.1 12.8929 6.30714 12.5286 6.53571 12.325C4.76071 12.1179 2.89286 11.4143 2.89286 8.27143C2.89286 7.375 3.20357 6.64286 3.71429 6.07143C3.63214 5.86429 3.35714 5.02857 3.79286 3.9C3.79286 3.9 4.46429 3.67857 5.99286 4.73929C6.63214 4.55714 7.31429 4.46786 7.99643 4.46429C8.675 4.46786 9.36071 4.55714 10 4.73929C11.5286 3.67857 12.1964 3.9 12.1964 3.9C12.6321 5.02857 12.3571 5.86429 12.275 6.07143C12.7857 6.64643 13.0964 7.37857 13.0964 8.27143C13.0964 11.4214 11.225 12.1143 9.44286 12.3179C9.72857 12.5714 9.98571 13.0714 9.98571 13.8357C9.98571 14.9321 9.975 15.8179 9.975 16.0857C9.975 16.3036 10.1179 16.5607 10.525 16.4786C13.7107 15.3964 16 12.325 16 8.70357C16 4.17143 12.4179 0.5 8 0.5Z"
                                    fill="#D0D5DD" />
                            </svg>
                            GitHub
                        </a>
    ...
    <!-- Copy User Link -->
    <script src="{{ asset('js/share-user-profile.js') }}"></script>
