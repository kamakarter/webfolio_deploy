...
<section class="form-section">
    <div class="container">
            ...
            <div class="form-modal-container form-upload-container form-canvas shadow-s">
                <form action="{{ route('upload.user.background', Auth::user()->id) }}" class="form-upload-box" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-div form-div-file">
                        ...
                        <label for="user_bg" class="form-label">
                            Добавьте обложку для проекта*
                        </label>
        
                        <div class="file-upload">
                            <label>
                                <input type="file" name="user_bg" class="input-file">
