...
@section('content')
    ...
    <div class="container">
    <img src="/assets/media/images/info-item-image.png" alt="image-home-page" class="banner-image-for-bg one zoom">
    <img src="/assets/media/images/info-item-image-1.png" alt="image-home-page" class="banner-image-for-bg two zoom">
    <img src="/assets/media/images/info-item-image-2.png" alt="image-home-page" class="banner-image-for-bg three zoom">
    ...
    <div class="banner-users_box">
        ...
        <div class="banner-users_box_images fade-in-down">
            <div class="avatar_box">
                <img
                    class="banner-avatar" 
                    src="/assets/media/users_avatar/Avatar-1.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="/assets/media/users_avatar/Avatar-2.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="assets/media/users_avatar/Avatar-3.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="assets/media/users_avatar/Avatar-4.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="../../assets/media/users_avatar/Avatar-5.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="../../assets/media/users_avatar/Avatar-6.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="../../assets/media/users_avatar/Avatar-7.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="../../assets/media/users_avatar/Avatar-8.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="../../assets/media/users_avatar/Avatar-9.png"
                    alt="banner-avatar"
                >
                <img
                    class="banner-avatar" 
                    src="../../assets/media/users_avatar/Avatar-10.png"
                    alt="banner-avatar"
                >
            </div>
        </div>
    ...
    <div class="banner-main_box">
        ...
        <div class="banner-btns_box fade-in-down">
            <a href="?p=reg" class="btn-white btn btn-m banner-btn-create">Создать портфолио</a>
    ...
    <img src="../../assets/media/images/star-info.svg" alt="star" class="animate">
    <div class="info-first_inner_box">
        ...
        <div class="info-logo_box animate">
            <img src="../../assets/media/images/logo-icon.svg" alt="logotype">
    ...
    <div class="info-item">
        ...
        <div class="right_section one">
            <img src="../../assets/media/images/info-item-image.png" alt="image" class="right-section-image">
        </div>
    </div>
    ...
    <div class="info-item">
        ...
        <div class="right_section two">
            <img src="../../assets/media/images/info-item-image-1.png" alt="image" class="right-section-image">
        </div>
    </div>
    ...
    <div class="info-item">
        ...
        <div class="right_section three">
            <img src="../../assets/media/images/info-item-image-2.png" alt="image" class="right-section-image">
        </div>
    </div>
    </div>
    </div>
